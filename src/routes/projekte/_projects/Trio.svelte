...
<Project>
    <div id='pictures-std'>
        <picture>
            ...
            <img src='/images/tekla-varga-1024.jpg' alt='Tekla Varga, Flöte' class='picture'>
        </picture>
        <picture>
            <source srcset='/images/verena-weber-512.jpg 512w'>
            <img src='/images/verena-weber-1024.jpg' alt='Verena Weber, Bratsche' class='picture'>
        </picture>
        <picture>
            <source srcset='/images/louise-augoyard-512.jpg 512w'>
            <img src='/images/louise-augoyard-1024.jpg' alt='Louise Augoyard, Harfe' class='picture'>
        </picture>
    </div>
    ...
    <div id='content'>
        ...
        <div id='pictures-mobile'>
            <picture>
                ...
                <img src='/images/tekla-varga-portrait-384.jpg' alt='Tekla Varga, Flöte' class='picture'>
            </picture>
            <picture>
                <source scrset='/images/verena-weber-portrait-128.jpg 128w'>
                <img src='/images/verena-weber-portrait-384.jpg' alt='Verena Weber, Bratsche' class='picture'>
            </picture>
            <picture>
                <source srcset='/images/louise-augoyard-portrait-128.jpg 128w'>
                <img  src='/images/louise-augoyard-portrait-384.jpg' alt='Louise Augoyard, Harfe' class='picture'>
            </picture>
        </div>
