<script>
    ...
    import { MESSAGE_API } from './api.js';
    ...
    const CONTENT = {
        ...
        'error-link': {
            ...
            fr: 'Le message ne doit pas contenir des liens.',
        ...
        submitted: {
            ...
            fr: 'Le message est envoyé...',
            en: 'Sending message...',
        },
        sent: {
            de: 'Danke, ich habe ihre Nachricht erhalten und werde so bald wie möglich antworten.',
            fr: 'Merci. J’ai reçu votre message et je vais répondre le plus vite possible.',
...
<img class='pic-mobile' src='/images/contact-mobile.jpg' alt='Louise Augoyard'>
...
<form id='contact-form'>
        ...
        {:else if message_status === 'submitted'}
            <p class='contact-feedback' transition:fade>{CONTENT.submitted[$state.language]}</p>
        {:else if message_status === 'sent'}
            <p class='contact-feedback' transition:fade>{CONTENT.sent[$state.language]}</p>
        {:else if message_status === 'error'}
            <p class='contact-feedback' transition:fade>{CONTENT.error[$state.language]}</p>
        {/if}
    </form>
</Main> 
